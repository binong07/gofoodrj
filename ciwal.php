...
include "begol.php";
echo color("white","PPMRJ x GOFOOD\n");
echo color("white","MAKASAR EDITION\n");
echo color("white","Terimakasih, Nadiem atas Vouchernya\n");
// function change(){
        $nama = nama();
        ...
        echo color("green","+] KODE SUDAH TERKIRIM BRO")."\n";
        otp:
        echo color("nevy","?] Otp: ");
        ...
        echo color("yellow","\n==========INI MI VOUCHER YANG MUTUNGGU===========");
        echo "\n".color("blue","!] Claim voc GOFOODSANTAI19");
        echo "\n".color("blue","!] MATTAJANGKKO je");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(1);
        }
        ...
        if(strpos($code1, 'PROMO INI KAMU BISA PAKAI')){
        echo "\n".color("green","+] Message: ".$message);
        goto goride;
        }else{
        echo "\n".color("yellow","-] Message: ".$message);
        echo "\n".color("blue","!] Claim voc GOFOODSANTAI11");
        echo "\n".color("blue","!] TAJANG MUI JE");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(1);
        }
        ...
        echo "\n".color("blue","!] Claim voc GOFOODSANTAI08");
        echo "\n".color("blue","!] TAJANG I NA");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(1);
        }
	...
	$post = [
 		'chat_id' => $chatid,
            ...
            echo color("red","-] SALAH PENGIMPUTANMU ANGGOTA");
            echo"\n==================================\n\n";
            echo color("yellow","!] SILAHKAN INPUT MI\n");
            goto otp;
            }
         }else{
         echo color("red","-] SABBARAKO ANGGOTA PURANI TERDAFTAR");
         echo"\n==================================\n\n";
